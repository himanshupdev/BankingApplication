...
public class BankingApp {
    ...
    private JButton createBackButton(Runnable action) {
        ...
        backButton.setBounds(50, 50, 100, 40); // Position and size
    ...
    private void displayLogin() {
        ...
        JButton backButton = createBackButton(this::displayHomeScreen);
    ...
    private void displayDashboard() {
        ...
        // Add back button
        JButton backButton = createBackButton(this::displayLogin); // Navigate back to login screen
        panel.add(backButton);
    ...
    private void placeDashboardComponents(JPanel panel) {
        ...
        JLabel balanceLabel = new JLabel("Available Balance: INR " + currentAccount.getBalance());
        balanceLabel.setBounds(450, 150, 400, 40);
        balanceLabel.setFont(new Font("Arial", Font.PLAIN, 24));
        panel.add(balanceLabel);
    
        // Place Refresh Balance button below the balance label
        JButton refreshButton = new JButton("Refresh Balance");
        refreshButton.setBounds(540, 200, 200, 40); // Position directly below balanceLabel
        refreshButton.setBackground(new Color(100, 149, 237));
        refreshButton.setForeground(Color.WHITE);
        panel.add(refreshButton);
    
        // Action to refresh the balance display
        refreshButton.addActionListener(e -> {
            balanceLabel.setText("Current Balance: INR " + currentAccount.getBalance());
            JOptionPane.showMessageDialog(frame, "Balance updated!");
        });
    
        // Other dashboard buttons remain unchanged
        JButton depositButton = new JButton("Deposit");
        depositButton.setBounds(540, 250, 200, 50);
        depositButton.setBackground(new Color(100, 149, 237));
        depositButton.setForeground(Color.WHITE);
        panel.add(depositButton);
    
        JButton withdrawButton = new JButton("Withdraw");
        withdrawButton.setBounds(540, 310, 200, 50);
        withdrawButton.setBackground(new Color(100, 149, 237));
        withdrawButton.setForeground(Color.WHITE);
        panel.add(withdrawButton);
    
        JButton transferButton = new JButton("Transfer");
        transferButton.setBounds(540, 390, 200, 50);
        transferButton.setBackground(new Color(100, 149, 237));
        transferButton.setForeground(Color.WHITE);
        panel.add(transferButton);
    
        JButton transactionHistoryButton = new JButton("Transactions");
        ...
        changePinButton.setBounds(540, 530, 200, 50);
        ...
        logoutButton.setBounds(540, 590, 200, 50);
